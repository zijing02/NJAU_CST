...
public class SyncManager {
    ...
    public static final Lock ioLock = new ReentrantLock(); // I/O 操作锁
    ...
    public static final Condition inputCondition = ioLock.newCondition(); // 输入操作的条件变量
    public static final Condition outputCondition = ioLock.newCondition(); // 输出操作的条件变量
    ...
    public static final Condition inputBeforeClk = ioLock.newCondition(); // I/O 操作在时钟中断之前完成的条件变量
    public static final Condition outputBeforeClk = ioLock.newCondition(); // I/O 操作在时钟中断之前完成的条件变量
