...
Begin VB.Form Update_Form_2 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.ComboBox Combo2 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "Update_Form_2.frx":0000
         Left            =   6360
         List            =   "Update_Form_2.frx":0019
         TabIndex        =   20
         Top             =   2520
         Width           =   2445
      End
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "Update_Form_2.frx":0051
         Left            =   1800
         List            =   "Update_Form_2.frx":0070
         TabIndex        =   16
         Top             =   1080
         Width           =   2445
      End
      Begin VB.ComboBox Combo3 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "Update_Form_2.frx":00AA
         Left            =   6360
         List            =   "Update_Form_2.frx":00B4
         TabIndex        =   15
         Top             =   3060
         Width           =   2445
      End
   ...
   End
End
Attribute VB_Name = "Update_Form_2"
...
Private Sub Command1_Click()
  ...
  '================== 读Person_IP的“人才基本信息表”记录
   ...
   strSQL = "select * from BTab where BTab.Person_ID='" + Trim(ID_Person) + "'"
   ...
   If rs.EOF And rs.BOF Then
      ...
      Exit Sub
   Else
      rs!name = Trim(name_Text.Text)
      rs!Person_ID = AreaNo_LabLe.Caption
   End If
   rs.Close
   Set rs = Nothing
   conODBC.Close
