                ...
                <table class="table tb caption-top table-hover">
                    <thead class="table-primary">
                        <tr>
                            ...
                            <th class="hh2"><span class="box">订货量</span></th>
                        </tr>
                    </thead>
...
export default {
    ...
    setup() {
        ...
        //CountOrderNumOfArea
        $.ajax({
            url: 'https://fb74-240e-478-810-9d7c-6574-8a60-376-aade.ngrok-free.app/CountOrderNumOfAreaAndCustomers',
            type: 'get',
